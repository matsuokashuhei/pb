...
The simplest way to use pb is to specify a start time and end time:
...
```bash
# Update every second (for short-term monitoring)
pb --start "2025-01-27 14:00:00" --end "30m" --interval 1

# Update every 5 minutes (for longer sessions)
